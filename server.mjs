...
let addImagePrompt = "Additionally, generate a prompt for the DALL-E API that you can use to create an image that maps to the scene. This should always be the last sentence of your response and it should beging with IMAGE_PROMPT: and then the prompt";

let imagePrompt = "A mysterious island at twilight surrounded by fog."
let imageStyle = "black and white, mysterious, high quality, in the style of adventure games from the 90s, pixel art"
/* End Prompts */
